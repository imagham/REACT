  ...
  return (
    <>
      <section className="bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center py-24 px-6 sm:px-12 relative">
        <pre className="absolute top-4 right-32 bg-white text-black font-semibold rounded-lg shadow-lg  transition duration-300 py-3 px-5">{userProfile}</pre>
        <Link onClick={() => localStorage.removeItem("authToken")} to="/" className="absolute top-4 right-4 bg-white text-blue-600 font-semibold rounded-lg shadow-lg hover:bg-gray-200 transition duration-300 py-3 px-5">
          logOut
        </Link>
